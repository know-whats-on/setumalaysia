...
MANIFEST_PATH = DATA_DIR / "hoodie-gold-coast-guide-image-manifest.json"
DEFAULT_APP_VARIANT = "all"
CITY = "Gold Coast"
STATE = "QLD"
SMOKE_EMAIL = "talkwithrushi@gmail.com"

GOLD_COAST_CSV_PATHS = [
    Path("/Users/rushi/Downloads/gold-coast-10-best-hidden-bars-in-gold-coast.csv"),
    Path("/Users/rushi/Downloads/gold-coast-10-best-cafes-to-work-from-in-gold-coast.csv"),
    Path("/Users/rushi/Downloads/gold-coast-10-best-historical-places-in-gold-coast.csv"),
    Path("/Users/rushi/Downloads/gold-coast-10-best-sunset-spots-in-gold-coast.csv"),
    Path("/Users/rushi/Downloads/gold-coast-10-best-weekend-getaways-from-gold-coast.csv"),
    Path("/Users/rushi/Downloads/gold-coast-10-best-sunrise-spots-in-gold-coast.csv"),
]

GUIDE_COVER_PLACE_POSITION = {
    "10-best-hidden-bars-in-gold-coast": 0,
    "10-best-cafes-to-work-from-in-gold-coast": 2,
    "10-best-historical-places-in-gold-coast": 0,
    "10-best-sunset-spots-in-gold-coast": 2,
    "10-best-weekend-getaways-from-gold-coast": 4,
    "10-best-sunrise-spots-in-gold-coast": 0,
}
...
PLACE_SOURCE_URL_OVERRIDES = {
    "Gold Coast Historical Museum": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Southport School of Arts": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "ANZAC Park and memorial precinct, Southport": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Mudgeeraba Heritage Centre precinct": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Burleigh Head National Park heritage precinct": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Home of the Arts precinct": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Southport waterfront heritage area": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Currumbin Creek and old settlement area": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Natural Bridge / Springbrook interpretive heritage area": "https://upload.wikimedia.org/wikipedia/commons/c/cc/Tamborine_Mountain.jpg",
    "Old ferry / river settlement references around Nerang": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
    "Mr P.P.'s Deli & Rooftop": "https://upload.wikimedia.org/wikipedia/commons/e/ec/Elegant_Interior_Of_The_Cocktailbar_%28220991479%29.jpeg",
    "Miami Headland": "https://upload.wikimedia.org/wikipedia/commons/5/5f/Burleigh_Heads_beach.jpg",
}

WIKIPEDIA_TITLE_OVERRIDES = {
    "Burleigh Headland": ["Burleigh Head National Park"],
    "Snapper Rocks": ["Snapper Rocks"],
    "Point Danger": ["Point Danger"],
    "Surfers Paradise Beach": ["Surfers Paradise, Queensland"],
    "The Spit": ["Main Beach, Queensland"],
    "Main Beach": ["Main Beach, Queensland"],
    "Kirra Beach": ["Kirra, Queensland"],
    "Rainbow Bay": ["Rainbow Bay, Queensland"],
    "Currumbin Alley": ["Currumbin, Queensland"],
    "Miami Headland": ["Miami, Queensland"],
    "Burleigh Hill": ["Burleigh Heads, Queensland"],
    "SkyPoint Observation Deck": ["Surfers Paradise, Queensland"],
    "Tamborine Mountain lookouts": ["Tamborine Mountain"],
    "Miami Hill / North Burleigh headland": ["Miami, Queensland"],
    "Currumbin Creek mouth": ["Currumbin, Queensland"],
    "Broadwater Parklands": ["Southport, Queensland"],
    "HOTA precinct lake edge": ["Home of the Arts"],
    "Kirra Hill": ["Kirra, Queensland"],
    "Tallebudgera Creek western side": ["Burleigh Heads, Queensland"],
    "Paradise Point foreshore": ["Paradise Point, Queensland"],
    "Springbrook National Park": ["Springbrook National Park"],
    "Byron Bay": ["Byron Bay"],
    "North Stradbroke Island": ["North Stradbroke Island"],
    "Brisbane": ["Brisbane"],
    "Scenic Rim": ["Scenic Rim"],
    "Mount Warning / Wollumbin area": ["Mount Warning"],
    "Sunshine Coast": ["Sunshine Coast"],
    "Noosa Heads": ["Noosa Heads, Queensland"],
    "Murwillumbah": ["Murwillumbah"],
    "Gold Coast Historical Museum": ["Gold Coast, Queensland"],
    "Southport School of Arts": ["Southport, Queensland"],
    "ANZAC Park and memorial precinct, Southport": ["Southport, Queensland"],
    "Mudgeeraba Heritage Centre precinct": ["Mudgeeraba, Queensland"],
    "Burleigh Head National Park heritage precinct": ["Burleigh Head National Park"],
    "Home of the Arts precinct": ["Home of the Arts"],
    "Southport waterfront heritage area": ["Southport, Queensland"],
    "Currumbin Creek and old settlement area": ["Currumbin, Queensland"],
    "Natural Bridge / Springbrook interpretive heritage area": ["Springbrook National Park"],
    "Old ferry / river settlement references around Nerang": ["Nerang, Queensland"],
}

WIKIPEDIA_SEARCH_OVERRIDES = {
    "HOTA precinct lake edge": ["Home of the Arts Gold Coast", "HOTA Gold Coast"],
    "Broadwater Parklands": ["Broadwater Parklands Gold Coast", "Southport Broadwater Parklands"],
    "Gold Coast Historical Museum": ["Gold Coast Historical Museum", "Gold Coast museum history"],
    "Southport School of Arts": ["Southport School of Arts Gold Coast", "Southport Queensland heritage"],
    "ANZAC Park and memorial precinct, Southport": ["ANZAC Park Southport Gold Coast", "Southport Queensland"],
    "Mudgeeraba Heritage Centre precinct": ["Mudgeeraba Gold Coast heritage", "Mudgeeraba Queensland"],
    "Burleigh Head National Park heritage precinct": ["Burleigh Head National Park", "Burleigh Heads Queensland"],
    "Home of the Arts precinct": ["Home of the Arts Gold Coast", "HOTA Gold Coast"],
    "Southport waterfront heritage area": ["Southport Gold Coast waterfront", "Southport Queensland"],
    "Currumbin Creek and old settlement area": ["Currumbin Gold Coast", "Currumbin Queensland"],
    "Natural Bridge / Springbrook interpretive heritage area": ["Natural Bridge Springbrook", "Springbrook National Park"],
    "Old ferry / river settlement references around Nerang": ["Nerang Queensland", "Nerang Gold Coast"],
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Upload Gold Coast guides, host their images, and verify the live feeds."
    )
    parser.add_argument(
        "--app-variant",
        choices=["all", "burb_mate", "ghar"],
        default=DEFAULT_APP_VARIANT,
        help="Target app_variant to publish the Gold Coast guides into.",
    )
    parser.add_argument(
        "--admin-email",
    ...
    parser.add_argument(
        "--skip-manifest-write",
        action="store_true",
        help="Do not rewrite the Gold Coast image manifest after a successful import.",
    )
    parser.add_argument(
        "--skip-smoke",
        action="store_true",
...
def fetch_json(url: str) -> Any:
    request = urllib.request.Request(url, headers={"User-Agent": "CodexGoldCoastGuideImporter/1.0"})
...
def resolve_fallback_source(
    ...
    queries = WIKIPEDIA_SEARCH_OVERRIDES.get(
        place_name,
        [f"{place_name} Gold Coast Queensland", f"{place_name} Gold Coast", f"{place_name} Queensland", f"{place_name} Australia", place_name],
    )
...
def require_rows_consistent(path: Path, rows: list[dict[str, str]]) -> tuple[str, str]:
    ...
    if city != CITY or state != STATE:
        raise RuntimeError(f"{path.name} is not a Gold Coast guide CSV.")
...
def fetch_live_gold_coast_guides(base_url: str, public_anon_key: str, app_variant: str) -> list[dict[str, Any]]:
    response = image_tools.api_request(
        base_url,
        public_anon_key,
        "GET",
    ...
    if not isinstance(guides, list):
        raise RuntimeError("Could not load live Gold Coast guides.")
    return [guide for guide in guides if isinstance(guide, dict)]


def verify_live_gold_coast_guides(project_id: str, base_url: str, public_anon_key: str, app_variant: str) -> None:
    guides = fetch_live_gold_coast_guides(base_url, public_anon_key, app_variant)
    expected_slugs = {
        "10-best-hidden-bars-in-gold-coast",
        "10-best-cafes-to-work-from-in-gold-coast",
        "10-best-historical-places-in-gold-coast",
        "10-best-sunset-spots-in-gold-coast",
        "10-best-weekend-getaways-from-gold-coast",
        "10-best-sunrise-spots-in-gold-coast",
    }
    live_slugs = {str(guide.get("slug") or "").strip() for guide in guides}
    if live_slugs != expected_slugs:
        raise RuntimeError(f"Live Gold Coast guide slugs mismatch for {app_variant}. Expected {sorted(expected_slugs)}, found {sorted(live_slugs)}")
    ...
    if len(guides) != 6:
        raise RuntimeError(f"Expected 6 live Gold Coast guides for {app_variant}, found {len(guides)}.")
    if len(cover_urls) != 6:
        raise RuntimeError(f"Gold Coast guide covers are not unique for {app_variant}.")

    print(f"VERIFY OK  live Gold Coast guides [{app_variant}] -> {len(guides)} guides, {verified_images} hosted images verified")
...
def ensure_admin_email_is_valid(base_url: str, public_anon_key: str, admin_email: str) -> None:
    ...
    if not isinstance(admins, list):
        raise RuntimeError("Could not load admin list before running Gold Coast guide import.")
...
def main() -> None:
    ...
    for csv_path in GOLD_COAST_CSV_PATHS:
    ...
    for variant in verification_variants:
        verify_live_gold_coast_guides(project_id, base_url, public_anon_key, variant)
    ...
    print(f"\nDONE       Gold Coast guides imported and verified for {args.app_variant}.")
